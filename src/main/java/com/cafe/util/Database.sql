...
(
    ...
    phone     VARCHAR(10),
    role      BIT          NOT NULL DEFAULT 0, -- 0 customer / 1 system
    admin     BIT          NOT NULL DEFAULT 0, -- 0 staff / 1 admin
    active    BIT                   DEFAULT 1
)
...
/* =========================
   INSERT DRINKS
========================= */
INSERT INTO drinks (category_id, name, price, image, description)
VALUES (1, N'Cà phê đen', 20000, 'cf_den.jpg', N'Cà phê đen truyền thống'),
...
/* =========================
   INSERT USERS
========================= */
INSERT INTO users (email, password, full_name, phone, role, admin)
VALUES ('anhhldts02418@gmail.com', '123', N'Huỳnh Lê Đức Anh', '0813716449', 1, 1),
       ('truongmk@poly.com', '123', N'Mai Phiến Chi', '0908070605', 1, 0),
       ('ngoctm@poly.com', '123', N'Trần Mỹ Ngọc', '0900000003', 1, 0),
       ('halvt@poly.com', '123', N'Lê Thanh Vân Hà', '0908070876', 1, 0),
       ('anhct@poly.com', '123', N'Chế Trâm Anh', '0908070986', 1, 0),
       ('thangtv@poly.com', '123', N'Trần Việt Thắng', '0918970605', 0, 0)


/* =========================
   INSERT BILLS
========================= */
INSERT INTO bills (table_id, user_id, code, total, status)
VALUES (1, 2, 'B001', 70000, 'finish'),
