                    ...
                    <div>
                        ...
                        <form method="get"
                            ...
                            <input type="text"
                                   ...
                                   value="${keyword}"
                                   placeholder="Tìm món..."
                                   class="md:col-span-2 rounded-lg border px-3 py-2 outline-none focus:ring-2 focus:ring-[#909632]"
                                   style="background:rgba(255,255,255,0.5);" />

                            <select name="categoryId"
                                    class="rounded-lg border px-3 py-2 outline-none focus:ring-2 focus:ring-[#909632]"
                                    style="background:rgba(255,255,255,0.5);">
                                <option value="">Tất cả loại món</option>
                                <c:forEach var="c" items="${categories}">
                                    <option value="${c.id}" ${filterCategoryId == c.id ? 'selected' : ''}>
                                            ${c.name}
                                    </option>
                                </c:forEach>
                            </select>
                            ...
                            <button type="submit"
                                    class="md:col-span-3 text-white py-2 rounded-lg shadow hover:scale-[1.01] transition"
